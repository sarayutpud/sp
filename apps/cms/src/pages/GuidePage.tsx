    ...
    <div className="page-block guide-page">
      ...
      <section id="overview" className="panel guide-section">
        ...
        <div className="guide-compare">
          <div className="guide-compare-card">
            <h3>CMS (เว็บนี้)</h3>
            <ul>
              <li>เพิ่มผู้เล่นทั้งสองทีม</li>
              <li>สร้างแมตช์ · จัดรายชื่อลงแข่ง</li>
              <li>ดู/ส่งออกใบสถิติ · แชร์ลิงก์</li>
          ...
          <div className="guide-compare-card">
            ...
            <ul>
              ...
              <li>ซิงก์เมื่อมีเน็ต · Excel / PDF FIBA</li>
            </ul>
          </div>
        </div>
      </section>
      ...
      <section id="courtside" className="panel guide-section">
        ...
        <ul className="guide-bullets">
          <li>
            ไม่ต้องสลับฝั่งก่อนทุกช็อต — ตอนเลือกคนจะเห็นทั้ง{" "}
            <span className="tone-home">เหย้า</span> /{" "}
            <span className="tone-away">เยือน</span>
          </li>
          ...
          <li>ปุ่มซิงก์ / คู่มือ / จบ Q / เปลี่ยนแมตช์ อยู่คอลัมน์ขวา</li>
        </ul>
      ...
      <section id="reports" className="panel guide-section">
        ...
        <ul className="guide-bullets">
          ...
          <li>แชร์ลิงก์สาธารณะได้โดยไม่ต้องล็อกอิน · ส่งออก PNG ของหน้าจอได้</li>
          <li>
      ...
      <section id="faq" className="panel guide-section">
        ...
        <dl className="guide-faq">
          ...
          <dd className="muted">
            ใช่ — เลือกจาก dropdown เท่านั้น ถ้ายังไม่มีทีม/ผู้เล่น ให้เพิ่มที่หน้าผู้เล่นก่อน
          </dd>
          ...
          <table className="data-table compact">
            ...
            <tbody>
              <tr>
                ...
                <td>เพิ่มทีมและผู้เล่นคู่แข่งในหน้าผู้เล่นก่อน</td>
              </tr>
              <tr>
